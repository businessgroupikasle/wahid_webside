...
export default function FooterMarquee() {
  ...
  return (
    <div className="relative w-full overflow-hidden mt-0 pt-2">
      ...
      <svg className="absolute inset-0 w-full h-full opacity-40 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="star-pattern" width="120" height="120" patternUnits="userSpaceOnUse">
            ...
            <circle cx="85" cy="20" r="1" fill="white" opacity="0.6" />
            <circle cx="25" cy="80" r="1" fill="white" opacity="0.3" />
            <circle cx="75" cy="85" r="1.5" fill="white" opacity="0.7" />
            <circle cx="105" cy="65" r="1" fill="white" opacity="0.4" />
          </pattern>
        </defs>
      ...
      <div className="absolute top-0 bottom-0 left-0 w-16 md:w-32 bg-gradient-to-r from-[#020617] to-transparent z-20 pointer-events-none" />
      <div className="absolute top-0 bottom-0 right-0 w-16 md:w-32 bg-gradient-to-l from-[#020617] to-transparent z-20 pointer-events-none" />
      {/* Slight bottom fade for the text */}
      <div className="absolute bottom-0 left-0 right-0 h-12 bg-gradient-to-t from-[#020617] to-transparent z-20 pointer-events-none" />
    </div>
  );
}
